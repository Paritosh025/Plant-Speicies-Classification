...
Original file is located at
    https://colab.research.google.com/drive/15zV3eIwSvCcmNFVJ-WeWVOXz2CFnvo1A
"""
...
# Define model
model = EfficientNetClassifier(num_classes=num_classes, lr=1e-3, model_name='efficientnet-b0')

# Callbacks
checkpoint_cb = ModelCheckpoint(monitor='val_acc', mode='max', save_top_k=1, filename='efficientnet-b0-best')
...
# Load the best model
best_model = EfficientNetClassifier.load_from_checkpoint(checkpoint_cb.best_model_path, num_classes=num_classes)
...
# At the end, save results for EfficientNet_B0
torch.save({
    'model_name': 'EfficientNet_B0',
    'accuracy': accuracy,
    'loss': avg_loss,
    'best_model_path': checkpoint_cb.best_model_path
},  'efficientnet-b0_results.pt')
